...
export default function ClientDocuments() {
  ...
  return <>
    ...
    {client && <DocumentStatusList clientId={client.id} onlySent heading={false} emptyMessage="Nothing has been sent to you yet. Your adviser will send any documents here." />}
  </>
}
