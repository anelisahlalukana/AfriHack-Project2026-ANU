...
export default function Dashboard() {
  ...
  return <><header className="page-heading"><div><p className="eyebrow">THE BIG PICTURE</p><h1>Your clients, at a glance</h1><p>Meaningful progress starts with understanding the whole picture.</p></div><Link className="button primary" to="/clients?add=1"><Plus size={17} /> Add client</Link></header>
