...
import ClientPortalLinks from '../components/tasks/ClientPortalLinks'
...
export default function ClientAccount() {
  ...
  return <main className="account-page"><section className="card">
    ...
    {isStaff(user) ? <Link className="button primary" to="/">Open your workspace</Link> : <><p>Report a claim, ask for a change, and track everything in one place.</p><ClientPortalLinks /></>}
