...
CREATE OR REPLACE FUNCTION public.reminders_send_message(p_client_id uuid,p_sender_id uuid,p_sender_name text,p_sender_role text,p_body text)
...
BEGIN
 ...
 PERFORM public.reminders_publish_event(p_client_id,'message:'||m.id,'New message',
...
CREATE OR REPLACE FUNCTION public.reminders_claim_push()
...
$$;
REVOKE ALL ON FUNCTION public.reminders_publish_event(uuid,text,text,text,text,text,uuid), public.reminders_send_message(uuid,uuid,text,text,text), public.reminders_run_reminders(), public.reminders_claim_push() FROM PUBLIC, anon, authenticated;
GRANT EXECUTE ON FUNCTION public.reminders_publish_event(uuid,text,text,text,text,text,uuid), public.reminders_send_message(uuid,uuid,text,text,text), public.reminders_run_reminders(), public.reminders_claim_push() TO service_role;
